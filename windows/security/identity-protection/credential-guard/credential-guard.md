...
- [Trusted Platform Module](/windows/device-security/tpm/trusted-platform-module-overview)'- [Mitigating Credential Theft using the Windows 10 Isolated User Mode](https://docs.microsoft.com/en-us/shows/seth-juarez/mitigating-credential-theft-using-windows-10-isolated-user-mode)
